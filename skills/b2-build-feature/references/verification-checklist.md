...
El cierre del trabajo (doc `docs/readme.md`, CHANGELOG, commit via b3, reporte) vive en
...
- [ ] Doc del feature `docs/readme.md` presente (feature nuevo) o actualizada (contratos/pantallas cambiados)
